...
<html lang="en">
  ...
  <body>
    ...
    <section>
        ...
        <div class="row" style="justify-content: center">
            <div class="col-md-6">
              ...
              <h6 style="margin-top: 50px">Title: KKN di Desa Sukamaju</h6>
              <h6>Author: Abah Lala</h6>
              <h6>Publisher: Agung Wijaya inc </h6>
              <h6>Year: 2019</h6>
              <h6>Description:</h6>
              <p>Kisah ini sangatlah seram.</p>
              <br>
    ...
    <section>
      ...
      <div class="footer bg-dark" style="color: white; margin-top: 236px; padding: 10px 0; display: flex; justify-content: center">
